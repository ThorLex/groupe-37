...
import { Home, FileText, ChevronLeft, ChevronRight, Fingerprint, LogOut, IdCard } from "lucide-react";
...
export default function Sidebar({ isCollapsed, toggleCollapse }: SidebarProps) {
  ...
  const navItems = [
    ...
    { href: "/admin/dashboard/cni_available", label: "CNI Disponible", icon: <IdCard size={20} /> },
  ];
